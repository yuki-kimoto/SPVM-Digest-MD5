...
int32_t SPVM__Digest__MD5__new(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  void* obj_md5 = env->new_object_by_name(env, stack, "Digest::MD5", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
  ...
  env->set_field_object_by_name(env, stack, obj_md5, "Digest::MD5", "context", "Digest::MD5::Context", obj_ctx, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
  
  stack[0].oval = obj_md5;
...
int32_t SPVM__Digest__MD5__add(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  void* obj_ctx = env->get_field_object_by_name(env, stack, obj_md5, "Digest::MD5", "context", "Digest::MD5::Context", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
